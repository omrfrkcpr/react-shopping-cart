...
import mallImg from "../assets/shopping-mall-construction.avif";
...
const About = () => {
  ...
  return (
    <div style={aboutDivStyle} className="pt-5 pb-5">
      <div className="w-75 m-auto bg-white p-3">
        <div className="about-img text-center mt-3">
          <img src={mallImg} alt="" width="300px" />
        </div>
        <div className="about-info">
          <h3 className="text-center mt-5 text-danger">
            About Our Shopping Mall
          </h3>
          <h5 className="mt-5 p-2 text-center">
          ...
          <h6 className="mt-2 p-2">History</h6>
          ...
          <h6 className="mt-2 p-2">Growth and Expansion</h6>
          <p className="mt-2 p-2">
          ...
          <h6 className="mt-2 p-2">Our Mission</h6>
          <p className="mt-2 p-2">
          ...
          <h6 className="mt-2 p-2">Community Engagement</h6>
          <p className="mt-2 p-2">
          ...
          <h6 className="mt-2 p-2">Future Vision</h6>
          <p className="mt-2 p-2">
